...
import (
	...
	"github.com/swaggest/go-asyncapi/reflector/asyncapi-2.5.0"
	"github.com/swaggest/go-asyncapi/spec-2.5.0"
)
...
func TestReflector_AddChannel(t *testing.T) {
	...
	assertjson.EqualMarshal(t, []byte(`{
	  ...
	  "channels":{
		"another.one":{
		  "subscribe":{
			"message":{"$ref":"#/components/messages/Asyncapi250TestMyAnotherMessage"}
		  }
		},
		"one.{name}.two":{
		  "parameters":{"name":{"schema":{"description":"Name","type":"string"}}},
		  "publish":{"message":{"$ref":"#/components/messages/Asyncapi250TestMyMessage"}}
		}
	  },
	  "components":{
		"schemas":{
		  "Asyncapi250TestMyAnotherMessage":{
			"properties":{
			  "item":{
				"$ref":"#/components/schemas/Asyncapi250TestSubItem",
				"description":"Some item"
			  }
			},
			"type":"object"
		  },
		  "Asyncapi250TestMyMessage":{
			"properties":{
			  "createdAt":{"description":"Creation time","format":"date-time","type":"string"},
			  "items":{
				"description":"List of items",
				"items":{"$ref":"#/components/schemas/Asyncapi250TestSubItem"},
				"type":["array","null"]
			  }
			},
			"type":"object"
		  },
		  "Asyncapi250TestSubItem":{
			"properties":{
		...
		"messages":{
		  "Asyncapi250TestMyAnotherMessage":{
			...
			"payload":{"$ref":"#/components/schemas/Asyncapi250TestMyAnotherMessage"},
			"summary":"Sample consumer",
			"description":"This is another sample schema"
		  },
		  "Asyncapi250TestMyMessage":{
			"payload":{"$ref":"#/components/schemas/Asyncapi250TestMyMessage"},
