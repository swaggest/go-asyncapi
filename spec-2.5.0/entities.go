...
func (a *AsyncAPI) WithServers(val map[string]ServerOrRef) *AsyncAPI {
	a.Servers = val
	return a
}

// WithServersItem sets Servers item value.
func (a *AsyncAPI) WithServersItem(key string, val ServerOrRef) *AsyncAPI {
	if a.Servers == nil {
		a.Servers = make(map[string]ServerOrRef, 1)
	}
...
func (a *AsyncAPI) UnmarshalJSON(data []byte) error {
	...
	if v, exists := rawMap["asyncapi"]; exists && string(v) != `"2.5.0"` {
		return fmt.Errorf(`bad const value for "asyncapi" ("2.5.0" expected, %s received)`, v)
	}
...
var constAsyncAPI = json.RawMessage(`{"asyncapi":"2.5.0"}`)
...
// Info structure is generated from "http://asyncapi.com/definitions/2.5.0/info.json".
//
// General information about the API.
type Info struct {
...
// Contact structure is generated from "http://asyncapi.com/definitions/2.5.0/contact.json".
//
...
// License structure is generated from "http://asyncapi.com/definitions/2.5.0/license.json".
type License struct {
...
// Reference structure is generated from "http://asyncapi.com/definitions/2.5.0/Reference.json".
...
// Server structure is generated from "http://asyncapi.com/definitions/2.5.0/server.json".
//
...
type Server struct {
	...
	Variables       map[string]ServerVariableOrRef `json:"variables,omitempty"`
...
func (s *Server) WithVariables(val map[string]ServerVariableOrRef) *Server {
	s.Variables = val
	return s
}

// WithVariablesItem sets Variables item value.
func (s *Server) WithVariablesItem(key string, val ServerVariableOrRef) *Server {
	if s.Variables == nil {
		s.Variables = make(map[string]ServerVariableOrRef, 1)
	}
...
// WithTags sets Tags value.
func (s *Server) WithTags(val ...Tag) *Server {
	s.Tags = val
	return s
}
...
// ServerVariable structure is generated from "http://asyncapi.com/definitions/2.5.0/serverVariable.json".
//
...
// ServerVariableOrRef structure is generated from "http://asyncapi.com/definitions/2.5.0/serverVariables.json->additionalProperties".
type ServerVariableOrRef struct {
	Reference      *Reference      `json:"-"`
	ServerVariable *ServerVariable `json:"-"`
}

// WithReference sets Reference value.
func (s *ServerVariableOrRef) WithReference(val Reference) *ServerVariableOrRef {
	s.Reference = &val
	return s
}

// ReferenceEns ensures returned Reference is not nil.
func (s *ServerVariableOrRef) ReferenceEns() *Reference {
	if s.Reference == nil {
...
// WithServerVariable sets ServerVariable value.
func (s *ServerVariableOrRef) WithServerVariable(val ServerVariable) *ServerVariableOrRef {
	s.ServerVariable = &val
	return s
}

// ServerVariableEns ensures returned ServerVariable is not nil.
func (s *ServerVariableOrRef) ServerVariableEns() *ServerVariable {
	if s.ServerVariable == nil {
		s.ServerVariable = new(ServerVariable)
	}

	return s.ServerVariable
}

// UnmarshalJSON decodes JSON.
func (s *ServerVariableOrRef) UnmarshalJSON(data []byte) error {
	var err error
	...
	err = json.Unmarshal(data, &s.ServerVariable)
	if err != nil {
		oneOfErrors["ServerVariable"] = err
		s.ServerVariable = nil
	} else {
		oneOfValid++
	}

	if oneOfValid != 1 {
		return fmt.Errorf("oneOf constraint failed for ServerVariableOrRef with %d valid results: %v", oneOfValid, oneOfErrors)
	}
...
// MarshalJSON encodes JSON.
func (s ServerVariableOrRef) MarshalJSON() ([]byte, error) {
	return marshalUnion(s.Reference, s.ServerVariable)
}

// ServerBindingsObject structure is generated from "http://asyncapi.com/definitions/2.5.0/serverBindingsObject.json".
...
// Tag structure is generated from "http://asyncapi.com/definitions/2.5.0/tag.json".
type Tag struct {
...
// ExternalDocs structure is generated from "http://asyncapi.com/definitions/2.5.0/externalDocs.json".
//
...
// ServerOrRef structure is generated from "http://asyncapi.com/definitions/2.5.0/servers.json->additionalProperties".
type ServerOrRef struct {
	Reference *Reference `json:"-"`
	Server    *Server    `json:"-"`
}

// WithReference sets Reference value.
func (s *ServerOrRef) WithReference(val Reference) *ServerOrRef {
	s.Reference = &val
	return s
}

// ReferenceEns ensures returned Reference is not nil.
func (s *ServerOrRef) ReferenceEns() *Reference {
	if s.Reference == nil {
		s.Reference = new(Reference)
	}
...
func (s *ServerOrRef) WithServer(val Server) *ServerOrRef {
	s.Server = &val
	return s
}

// ServerEns ensures returned Server is not nil.
func (s *ServerOrRef) ServerEns() *Server {
	if s.Server == nil {
		s.Server = new(Server)
	}
...
// UnmarshalJSON decodes JSON.
func (s *ServerOrRef) UnmarshalJSON(data []byte) error {
	var err error
	...
	if oneOfValid != 1 {
		return fmt.Errorf("oneOf constraint failed for ServerOrRef with %d valid results: %v", oneOfValid, oneOfErrors)
	}
...
// MarshalJSON encodes JSON.
func (s ServerOrRef) MarshalJSON() ([]byte, error) {
	return marshalUnion(s.Reference, s.Server)
}

// ChannelItem structure is generated from "http://asyncapi.com/definitions/2.5.0/channelItem.json".
type ChannelItem struct {
	Ref           string                    `json:"$ref,omitempty"`        // Format: uri-reference.
	Parameters    map[string]ParameterOrRef `json:"parameters,omitempty"`  // JSON objects describing re-usable channel parameters.
...
func (c *ChannelItem) WithParameters(val map[string]ParameterOrRef) *ChannelItem {
	c.Parameters = val
	return c
}

// WithParametersItem sets Parameters item value.
func (c *ChannelItem) WithParametersItem(key string, val ParameterOrRef) *ChannelItem {
	if c.Parameters == nil {
		c.Parameters = make(map[string]ParameterOrRef, 1)
	}
...
// Parameter structure is generated from "http://asyncapi.com/definitions/2.5.0/parameter.json".
...
// ParameterOrRef structure is generated from "http://asyncapi.com/definitions/2.5.0/parameters.json->additionalProperties".
...
// WithReference sets Reference value.
func (p *ParameterOrRef) WithReference(val Reference) *ParameterOrRef {
	p.Reference = &val
	return p
}

// ReferenceEns ensures returned Reference is not nil.
func (p *ParameterOrRef) ReferenceEns() *Reference {
	if p.Reference == nil {
...
// Operation structure is generated from "http://asyncapi.com/definitions/2.5.0/operation.json".
...
// OperationTrait structure is generated from "http://asyncapi.com/definitions/2.5.0/operationTrait.json".
...
// OperationBindingsObject structure is generated from "http://asyncapi.com/definitions/2.5.0/operationBindingsObject.json".
...
// OperationTraitsItems structure is generated from "http://asyncapi.com/definitions/2.5.0/operation.json->traits->items".
...
func (o OperationTraitsItems) MarshalJSON() ([]byte, error) {
	return marshalUnion(o.Reference, o.OperationTrait)
}

// MessageOneOf1OneOf0 structure is generated from "http://asyncapi.com/definitions/2.5.0/message.json/oneOf/1/oneOf/0".
...
// MessageEntity structure is generated from "http://asyncapi.com/definitions/2.5.0/message.json/oneOf/1/oneOf/1".
...
func (m *MessageEntity) WithPayload(val Schema) *MessageEntity {
	m.Payload = &val
	return m
}

// PayloadEns ensures returned Payload is not nil.
func (m *MessageEntity) PayloadEns() *Schema {
	if m.Payload == nil {
		m.Payload = new(Schema)
	}
...
// MessageOneOf1OneOf1Headers structure is generated from "http://asyncapi.com/definitions/2.5.0/message.json/oneOf/1/oneOf/1->headers".
...
// CorrelationID structure is generated from "http://asyncapi.com/definitions/2.5.0/correlationId.json".
...
// MessageOneOf1OneOf1CorrelationID structure is generated from "http://asyncapi.com/definitions/2.5.0/message.json/oneOf/1/oneOf/1->correlationId".
...
// MessageOneOf1OneOf1ExamplesItems structure is generated from "http://asyncapi.com/definitions/2.5.0/message.json/oneOf/1/oneOf/1->examples->items".
...
// MessageBindingsObject structure is generated from "http://asyncapi.com/definitions/2.5.0/messageBindingsObject.json".
...
// MessageTrait structure is generated from "http://asyncapi.com/definitions/2.5.0/messageTrait.json".
...
// MessageTraitHeadersAllOf1 structure is generated from "http://asyncapi.com/definitions/2.5.0/messageTrait.json->headers/allOf/1".
...
// MessageTraitHeaders structure is generated from "http://asyncapi.com/definitions/2.5.0/messageTrait.json->headers".
...
// MessageTraitCorrelationID structure is generated from "http://asyncapi.com/definitions/2.5.0/messageTrait.json->correlationId".
...
// MessageOneOf1OneOf1TraitsItems structure is generated from "http://asyncapi.com/definitions/2.5.0/message.json/oneOf/1/oneOf/1->traits->items".
...
func (m MessageOneOf1OneOf1TraitsItems) MarshalJSON() ([]byte, error) {
	return marshalUnion(m.Reference, m.MessageTrait)
}

// MessageOneOf1 structure is generated from "http://asyncapi.com/definitions/2.5.0/message.json/oneOf/1".
...
// Message structure is generated from "http://asyncapi.com/definitions/2.5.0/message.json".
type Message struct {
	Reference *Reference     `json:"-"`
...
// ChannelBindingsObject structure is generated from "http://asyncapi.com/definitions/2.5.0/channelBindingsObject.json".
...
// Components structure is generated from "http://asyncapi.com/definitions/2.5.0/components.json".
//
...
// WithServers sets Servers value.
func (c *Components) WithServers(val map[string]ServerOrRef) *Components {
	c.Servers = val
	return c
}

// WithServersItem sets Servers item value.
func (c *Components) WithServersItem(key string, val ServerOrRef) *Components {
	if c.Servers == nil {
		c.Servers = make(map[string]ServerOrRef, 1)
	}
...
func (c *Components) WithServerVariables(val map[string]ServerVariableOrRef) *Components {
	c.ServerVariables = val
	return c
}

// WithServerVariablesItem sets ServerVariables item value.
func (c *Components) WithServerVariablesItem(key string, val ServerVariableOrRef) *Components {
	if c.ServerVariables == nil {
		c.ServerVariables = make(map[string]ServerVariableOrRef, 1)
	}
...
// WithParameters sets Parameters value.
func (c *Components) WithParameters(val map[string]ParameterOrRef) *Components {
	c.Parameters = val
	return c
}

// WithParametersItem sets Parameters item value.
func (c *Components) WithParametersItem(key string, val ParameterOrRef) *Components {
	if c.Parameters == nil {
		c.Parameters = make(map[string]ParameterOrRef, 1)
	}
...
// UserPassword structure is generated from "http://asyncapi.com/definitions/2.5.0/userPassword.json".
...
// APIKey structure is generated from "http://asyncapi.com/definitions/2.5.0/apiKey.json".
type APIKey struct {
...
// X509 structure is generated from "http://asyncapi.com/definitions/2.5.0/X509.json".
type X509 struct {
	Description   string                 `json:"description,omitempty"`
	MapOfAnything map[string]interface{} `json:"-"` // Key must match pattern: `^x-[\w\d\.\x2d_]+$`.
}
...
// SymmetricEncryption structure is generated from "http://asyncapi.com/definitions/2.5.0/symmetricEncryption.json".
...
// AsymmetricEncryption structure is generated from "http://asyncapi.com/definitions/2.5.0/asymmetricEncryption.json".
...
// NonBearerHTTPSecurityScheme structure is generated from "http://asyncapi.com/definitions/2.5.0/NonBearerHTTPSecurityScheme.json".
...
// NonBearerHTTPSecuritySchemeNot structure is generated from "http://asyncapi.com/definitions/2.5.0/NonBearerHTTPSecurityScheme.json->not".
...
// BearerHTTPSecurityScheme structure is generated from "http://asyncapi.com/definitions/2.5.0/BearerHTTPSecurityScheme.json".
...
// APIKeyHTTPSecurityScheme structure is generated from "http://asyncapi.com/definitions/2.5.0/APIKeyHTTPSecurityScheme.json".
...
// HTTPSecurityScheme structure is generated from "http://asyncapi.com/definitions/2.5.0/HTTPSecurityScheme.json".
...
// Oauth2Flows structure is generated from "http://asyncapi.com/definitions/2.5.0/oauth2Flows.json".
...
// Oauth2FlowsFlows structure is generated from "http://asyncapi.com/definitions/2.5.0/oauth2Flows.json->flows".
...
// Oauth2Flow structure is generated from "http://asyncapi.com/definitions/2.5.0/oauth2Flow.json".
...
// OpenIDConnect structure is generated from "http://asyncapi.com/definitions/2.5.0/openIdConnect.json".
...
// SaslPlainSecurityScheme structure is generated from "http://asyncapi.com/definitions/2.5.0/SaslPlainSecurityScheme.json".
...
// SaslScramSecurityScheme structure is generated from "http://asyncapi.com/definitions/2.5.0/SaslScramSecurityScheme.json".
...
// SaslGssapiSecurityScheme structure is generated from "http://asyncapi.com/definitions/2.5.0/SaslGssapiSecurityScheme.json".
...
// SaslSecurityScheme structure is generated from "http://asyncapi.com/definitions/2.5.0/SaslSecurityScheme.json".
...
// SecurityScheme structure is generated from "http://asyncapi.com/definitions/2.5.0/SecurityScheme.json".
...
// ComponentsSecuritySchemesWD structure is generated from "http://asyncapi.com/definitions/2.5.0/components.json->securitySchemes->^[\w\d\.\-_]+$".
...
// ComponentsSecuritySchemes structure is generated from "http://asyncapi.com/definitions/2.5.0/components.json->securitySchemes".
...
// ComponentsCorrelationIdsWD structure is generated from "http://asyncapi.com/definitions/2.5.0/components.json->correlationIds->^[\w\d\.\-_]+$".
...
// ComponentsCorrelationIds structure is generated from "http://asyncapi.com/definitions/2.5.0/components.json->correlationIds".
