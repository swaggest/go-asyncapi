...
type MessageEntity struct {
	...
	Headers       *jsonschema.Schema          `json:"headers,omitempty"`
	Payload       *jsonschema.Schema          `json:"payload,omitempty"`
...
func (m *MessageEntity) WithHeaders(val jsonschema.Schema) *MessageEntity {
	m.Headers = &val
	return m
}

// WithPayload sets Payload value.
func (m *MessageEntity) WithPayload(val jsonschema.Schema) *MessageEntity {
	m.Payload = &val
	return m
}
