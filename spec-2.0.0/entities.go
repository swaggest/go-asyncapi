...
func (a *AsyncAPI) UnmarshalJSON(data []byte) error {
	...
	if v, exists := rawMap["asyncapi"]; exists && string(v) != `"2.0.0"` {
		return fmt.Errorf(`bad const value for "asyncapi" ("2.0.0" expected, %s received)`, v)
	}
...
var constAsyncAPI = json.RawMessage(`{"asyncapi":"2.0.0"}`)
...
func (m *MessageEntities) WithOneOf(val ...Message) *MessageEntities {
	m.OneOf = val
	return m
}

type marshalMessageEntities MessageEntities

var knownKeysMessageEntities = []string{
	"oneOf",
}

var requireKeysMessageEntities = []string{
	"oneOf",
}

// UnmarshalJSON decodes JSON.
func (m *MessageEntities) UnmarshalJSON(data []byte) error {
	var err error

	mm := marshalMessageEntities(*m)
	...
	for _, key := range requireKeysMessageEntities {
		if _, found := rawMap[key]; !found {
			return errors.New("required key missing: " + key)
		}
	}

	for _, key := range knownKeysMessageEntities {
		delete(rawMap, key)
	}
	...
	if len(rawMap) != 0 {
		...
		return fmt.Errorf("additional properties not allowed in MessageEntities: %v", offendingKeys)
	}

	*m = MessageEntities(mm)
...
func (m *MessageEntity) WithHeaders(val map[string]interface{}) *MessageEntity {
	m.Headers = val
	return m
}

// WithHeadersItem sets Headers item value.
func (m *MessageEntity) WithHeadersItem(key string, val interface{}) *MessageEntity {
	if m.Headers == nil {
...
func (m *MessageEntity) WithCorrelationID(val MessageEntityCorrelationID) *MessageEntity {
	m.CorrelationID = &val
	return m
}

// CorrelationIDEns ensures returned CorrelationID is not nil.
func (m *MessageEntity) CorrelationIDEns() *MessageEntityCorrelationID {
	if m.CorrelationID == nil {
		m.CorrelationID = new(MessageEntityCorrelationID)
	}
...
// WithExamples sets Examples value.
func (m *MessageEntity) WithExamples(val ...map[string]interface{}) *MessageEntity {
	m.Examples = val
	return m
}
...
// WithTraits sets Traits value.
func (m *MessageEntity) WithTraits(val ...MessageEntityTraitsItems) *MessageEntity {
	m.Traits = val
	return m
}
...
// WithReference sets Reference value.
func (m *MessageEntityCorrelationID) WithReference(val Reference) *MessageEntityCorrelationID {
	m.Reference = &val
	return m
}

// ReferenceEns ensures returned Reference is not nil.
func (m *MessageEntityCorrelationID) ReferenceEns() *Reference {
	if m.Reference == nil {
...
// WithCorrelationID sets CorrelationID value.
func (m *MessageEntityCorrelationID) WithCorrelationID(val CorrelationID) *MessageEntityCorrelationID {
	m.CorrelationID = &val
	return m
}

// CorrelationIDEns ensures returned CorrelationID is not nil.
func (m *MessageEntityCorrelationID) CorrelationIDEns() *CorrelationID {
	if m.CorrelationID == nil {
...
// UnmarshalJSON decodes JSON.
func (m *MessageEntityCorrelationID) UnmarshalJSON(data []byte) error {
	var err error
	...
	if oneOfValid != 1 {
		return fmt.Errorf("oneOf constraint failed for MessageEntityCorrelationID with %d valid results: %v", oneOfValid, oneOfErrors)
	}
...
// MarshalJSON encodes JSON.
func (m MessageEntityCorrelationID) MarshalJSON() ([]byte, error) {
...
// WithReference sets Reference value.
func (m *MessageEntityTraitsItems) WithReference(val Reference) *MessageEntityTraitsItems {
	m.Reference = &val
	return m
}

// ReferenceEns ensures returned Reference is not nil.
func (m *MessageEntityTraitsItems) ReferenceEns() *Reference {
	if m.Reference == nil {
		m.Reference = new(Reference)
	}
...
func (m *MessageEntityTraitsItems) WithMessageTrait(val MessageTrait) *MessageEntityTraitsItems {
	m.MessageTrait = &val
	return m
}

// MessageTraitEns ensures returned MessageTrait is not nil.
func (m *MessageEntityTraitsItems) MessageTraitEns() *MessageTrait {
...
// WithSliceOfAnything sets SliceOfAnything value.
func (m *MessageEntityTraitsItems) WithSliceOfAnything(val ...interface{}) *MessageEntityTraitsItems {
	m.SliceOfAnything = val
	return m
}

// UnmarshalJSON decodes JSON.
func (m *MessageEntityTraitsItems) UnmarshalJSON(data []byte) error {
	var err error
	...
	if oneOfValid != 1 {
		return fmt.Errorf("oneOf constraint failed for MessageEntityTraitsItems with %d valid results: %v", oneOfValid, oneOfErrors)
	}
...
// MarshalJSON encodes JSON.
func (m MessageEntityTraitsItems) MarshalJSON() ([]byte, error) {
...
func (m *Message) WithEntities(val MessageEntities) *Message {
	m.Entities = &val
	return m
}

// EntitiesEns ensures returned Entities is not nil.
func (m *Message) EntitiesEns() *MessageEntities {
	if m.Entities == nil {
		m.Entities = new(MessageEntities)
	}
...
func (m *Message) WithEntity(val MessageEntity) *Message {
	m.Entity = &val
	return m
}

// EntityEns ensures returned Entity is not nil.
func (m *Message) EntityEns() *MessageEntity {
	if m.Entity == nil {
		m.Entity = new(MessageEntity)
	}
...
func (m *Message) UnmarshalJSON(data []byte) error {
	...
	err = json.Unmarshal(data, &m.Entities)
	if err != nil {
		oneOfErrors["Entities"] = err
		m.Entities = nil
	} else {
		oneOfValid++
	}

	err = json.Unmarshal(data, &m.Entity)
	if err != nil {
		oneOfErrors["Entity"] = err
		m.Entity = nil
	} else {
		oneOfValid++
	}
...
func (m Message) MarshalJSON() ([]byte, error) {
	return marshalUnion(m.Reference, m.Entities, m.Entity)
}
...
func (s *SecurityScheme) UnmarshalJSON(data []byte) error {
	...
	oneOfErrors := make(map[string]error, 8)
	oneOfValid := 0
